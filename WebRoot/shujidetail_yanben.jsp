		 ...
		 <td width='11%' height=44>编号：</td><td width='39%'><%=mqt.get("bianhao")%></td><td  rowspan=5 align=center><a href=<%=mqt.get("fengmian")%> target=_blank><img src=<%=mqt.get("fengmian")%> width=228 height=215 border=0></a></td></tr><tr>         <td width='11%' height=44>分类：</td><td width='39%'><%=mqt.get("fenlei")%></td></tr><tr>         <td width='11%' height=44>书籍名称：</td><td width='39%'><%=mqt.get("shujimingcheng")%></td></tr><tr>         <td width='11%' height=44>作者：</td><td width='39%'><%=mqt.get("zuozhe")%></td></tr><tr>                  <td width='11%' height=44>出版社：</td><td width='39%'><%=mqt.get("chubanshe")%></td></tr><tr>                  <td width='11%' height=100  >内容：</td><td width='39%' colspan=2 height=100 ><%=mqt.get("neirong")%></td></tr><tr><td colspan=3 align=center>点赞数:<a href="shujidetail.jsp?id=<%=id%>&dztp=d"><img src="qtimages/ding.gif" width="40" height="40"> <%HashMap mdz = new CommDAO().getmap(id,"shuji");out.print(mdz.get("dianzan_d"));%></a> <a href="shujidetail.jsp?id=<%=id%>&dztp=c"><img src="qtimages/cai.gif" width="40" height="40"><%out.print(mdz.get("dianzan_c"));%></a> </td></tr><tr>							 
							...
							int i=0;
							 ...
							 %>
                                ...
                                </tr><tr><td colspan=3 align=center><input type=button name=Submit5 value=返回 class='hsgqiehuanshitu' onClick="javascript:history.back()" /><input type=button name=Submit52 value=打印 class='hsgqiehuanshitu' onClick="javascript:window.print()" /> <!--jixaaxnnxiu--><input type=button name=Submit53 value=评论 class='hsgqiehuanshitu' onClick="javascript:hsgpinglun('shuji','<%=id%>')"/><input type=button name=Submit52 value=收藏 class='hsgqiehuanshitu' onClick="javascript:location.href='jrsc.jsp?id=<%=mqt.get("id")%>&biao=shuji&ziduan=shujimingcheng';" /></td></tr>
